...
<html lang="en">
    ...
    <body background="img/pinkbg.jpg">
        <div class="container text-center">
            <h1><div id="font">Small Room Timetable</div></h1>
            ...
            <a href="largetime.php"><button class="button"><span>Large Room</span></button></a>
            <br> 
