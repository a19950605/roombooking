        ...
        <?php include_once 'db.php' ?>
            ...
            if ($numOfRecord <= 0) {
                ...
                while ($row = mysqli_fetch_array($result)) {
                        ...
                        "<td>" . $row["email"] . "</td>" . "<td>" . $row["mobile"] . "</td>" . "<td>" . $row["fee"] . "</td>".
                                "<td>".$row["login"]."</td>".
                            "<td><a href=\"studentStatus.php?studentno='".$row["studentno"]."'\"><button type=\"button\" class=\"btn btn-default\">change login status</a></td>"."</tr>";
                ...
                echo"</tbody>";
                       ...
                       echo"<a href=\"studentStatus.php\"><button type=\"button\" class=\"btn btn-default\">change login status</a>";
            ?>
